...
@router.post("/train")
async def train(
	training_data: Annotated[UploadFile, File],
	...
	hyperparameters = {"batch_size": batch_size, "learning_rate_multiplier": learning_rate_multiplier, "n_epochs": n_epochs}
	job_response = start_fine_tuning_job(training_file_id, validation_file_id, model, hyperparameters, SEED)
